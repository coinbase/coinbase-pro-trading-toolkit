...
export type CoinbaseProMessage =
    CoinbaseProErrorMessage |
    CoinbaseProHeartbeatMessage |
...
const COINBASE_PRO_MESSAGE_TYPES: ReadonlySet<string> = new Set(['error',
                                                         'heartbeat',
                                                         'subscriptions',
                                                         'received',
                                                         'open',
...
export function isCoinbaseProMessage(msg: any): msg is CoinbaseProMessage {
