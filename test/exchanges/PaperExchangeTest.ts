...
*/
    ...
    describe('should fill orders when', () => {
        ...
        it('trade price is below buy limit order', () => {
            // create buy limit order
            return paper.placeOrder(generatePlaceOrder({price: '10.00', orderType: 'limit', side: 'buy', postOnly: false})).then((liveOrder) => {
        ...
        it('trade price is above sell limit order', () => {
            // create sell limit order
            return paper.placeOrder(generatePlaceOrder({price: '10.00', orderType: 'limit', side: 'sell', postOnly: false})).then((liveOrder) => {
